...
| :--- | :--- | :--- |
| **Rastreada: actualmente sin indexar** | Google ha visitado la página pero ha decidido no guardarla, normalmente por baja calidad o contenido duplicado [según el informe de indexación](https://support.google.com/webmasters/answer/7440203?hl=en-419). | Mejora el contenido, añade enlaces internos y aporta valor real. |
| **Detectada: actualmente sin indexar** | Google sabe que la URL existe pero aún no ha tenido tiempo de rastrearla por falta de presupuesto de rastreo [según la guía de errores de rastreo](https://developers.google.com/search/docs/crawling-indexing/troubleshoot-crawling-errors). | Optimiza la velocidad de carga y la estructura de enlaces internos. |
